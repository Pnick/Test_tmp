...
@CucumberOptions(	features = { "Features" },
					glue	 = { "Tests" 	 },
					tags 	 = ("(@GameHistory) and not @manual and not @notSupported and not @notImplemented and not @CannotBeTested"),
					plugin   = { "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" })

public class RunnerHistoryIT{
...
//public class RunnerHistoryIT extends AbstractTestNGCucumberParallelTests {
//
//	public static String configPropertiesRun = "Configuration.properties";
//
//	@BeforeSuite
