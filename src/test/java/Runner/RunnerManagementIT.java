...
@CucumberOptions(
		features 	= 	{ "Features" },
		glue		= 	{ "Tests" },
		tags		= 	{ "~@manual", "~@notSupported", "~@notImplemented", "~@CannotBeTested","@GameManagement,@OperatorManagement,@ProviderManagement"},
		plugin 		= 	{"com.vimalselvam.cucumber.listener.ExtentCucumberFormatter:"})

public class RunnerManagementIT extends AbstractTestNGCucumberParallelTests{
