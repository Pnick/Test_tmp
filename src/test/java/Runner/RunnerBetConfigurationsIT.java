...
@CucumberOptions(
		features 	= 	{ "Features" },
		glue		= 	{ "Tests" },
		tags		= 	{ "~@manual", "~@notSupported", "~@notImplemented", "~@CannotBeTested", "@BetConfigurations, @ServerUpdate"},
		plugin 		= 	{"com.vimalselvam.cucumber.listener.ExtentCucumberFormatter:"}
		)
public class RunnerBetConfigurationsIT extends AbstractTestNGCucumberParallelTests {
